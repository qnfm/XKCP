...
#ifndef _Xoodoo_times4_AVX512_h_
#define _Xoodoo_times4_AVX512_h_
...
#define Xoodootimes4_AVX512_GetImplementation()      ("AVX512 implementation")
#define Xoodootimes4_AVX512_GetFeatures()           (PlSnP_Feature_Main | PlSnP_Feature_Farfalle)

#define Xoodootimes4_AVX512_StaticInitialize()
void Xoodootimes4_AVX512_InitializeAll(Xoodootimes4_align512SIMD128_states *states);
#define Xoodootimes4_AVX512_AddByte(states, instanceIndex, byte, offset) \
...
void Xoodootimes4_AVX512_PermuteAll_6rounds(Xoodootimes4_align512SIMD128_states *states);
void Xoodootimes4_AVX512_PermuteAll_12rounds(Xoodootimes4_align512SIMD128_states *states);
