...
SnP interface for the ARMv8.4-A SHA3-instructions single-state backend. The
accelerated 24-round permutation and absorb fast loop come from the SHA3 core;
all remaining operations are shared with the generic 64-bit backend.
...
typedef KeccakP1600_v84a_state KeccakP1600_state;

#define KeccakP1600_GetImplementation               KeccakP1600_v84a_GetImplementation
#define KeccakP1600_GetFeatures                     KeccakP1600_plain64_GetFeatures

#define KeccakP1600_StaticInitialize                KeccakP1600_v84a_StaticInitialize
...
#define KeccakP1600_Permute_Nrounds                 KeccakP1600_v84a_Permute_Nrounds
#define KeccakP1600_Permute_12rounds                KeccakP1600_plain64_Permute_12rounds
#define KeccakP1600_Permute_24rounds                KeccakP1600_v84a_Permute_24rounds
...
#define KeccakF1600_FastLoop_Absorb                 KeccakF1600_v84a_FastLoop_Absorb
