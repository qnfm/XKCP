...
void Xoodootimes8_AVX512_PermuteAll_6rounds(Xoodootimes8_align512SIMD256_states *argstates)
{
...
void Xoodootimes8_AVX512_PermuteAll_12rounds(Xoodootimes8_align512SIMD256_states *argstates)
{
    V256 * states = argstates->A;
    DeclareVars;
