// Keccak-p[1600]x4 hybrid scalar+NEON+SHA3 permutation for AArch64 (ARMv8.4-A),
// processing four parallel states. Verified hybrid from mlkem-native
// (keccak_f1600_x4_v8a_v84a_scalar_hybrid_aarch64_asm.S), derived from:
//
...
//
// The verified body is reproduced verbatim; only the mlkem include/guards and
// symbol-naming macros are replaced. State is four sequential Keccak states
// (uint64_t[100]); round constants in standard order.
//
...
//
// void KeccakP1600times4_v84a_permute24(uint64_t state[100], const uint64_t rc[24])
...
.text
.balign 4
.global XKCP_SYM(KeccakP1600times4_v84a_permute24)
#if defined(__ELF__)
.type XKCP_SYM(KeccakP1600times4_v84a_permute24), %function
#endif
XKCP_SYM(KeccakP1600times4_v84a_permute24):
...
#if defined(__ELF__)
.size XKCP_SYM(KeccakP1600times4_v84a_permute24), .-XKCP_SYM(KeccakP1600times4_v84a_permute24)
#endif
